# NYC Council Full Stack Coding Challenge

You will have **1 full week** to complete this challenge starting when you received the challenge from our office. You can submit your challenge by pushing it to your own git provider repository and share the link with us via email.
...
- A SQLite3 database that’s already seeded with User data, UserProfile data, and Complaint data.
  - Each login follows this format:
    ...
    - (ie. Mark Levine from District 7 's account willl be username=mlevine, password=levine-7, Data can be found in **/Users/testApp/complaint_app/management/commands/councilMembers.json** )
...
1. Start by **cloning** this [Azure DevOps repository](https://dev.azure.com/avaliance/AVAMA%20-%20Coding%20Challenges/_git/full-stack-coding-challenge) to download the starter code.
...
4. Inside the main directory (`full-stack-coding-challenge/testApp`), run the following commands to install your dependencies and set up your database:
...
5. Inside of the React app (`full-stack-coding-challenge/testApp/frontend`), run `yarn` to get all of your frontend dependencies.
6. From there you should be able to start your frontend and backend using `yarn start` and `python manage.py runserver`, respectively.
...
**NOTE**: All complain endpoints should return complaints that occur in the user's district. View the "[Important things to know about the data](https://dev.azure.com/avaliance/AVAMA%20-%20Coding%20Challenges/_git/full-stack-coding-challenge#important-things-to-know-about-the-data)" section for more clarification.

## MVP

### The Django Side ([Django Documentation](https://docs.djangoproject.com/en/2.2/))

1. Fill in the empty viewsets with database queries that the frontend is requesting (see React MVP #2) (`full-stack-coding-challenge/testApp/complaint_app/views.py`) ([Django REST framework viewset documentation](https://www.django-rest-framework.org/api-guide/viewsets/))

### The React Side ([React Documentation](https://reactjs.org/docs/getting-started.html))

1. Create a simple login page for Council members to input their credentials (see above in the ‘[What we’re providing](https://dev.azure.com/avaliance/AVAMA%20-%20Coding%20Challenges/_git/full-stack-coding-challenge#what-were-providing)’ section for the format)
